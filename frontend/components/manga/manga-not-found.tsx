      ...
      <div className="mx-auto max-w-md text-center space-y-8">
        ...
        <div className="space-y-3">
          ...
          <p className="text-lg text-muted-foreground">
            El manga con ID <span className="font-mono font-semibold text-foreground">{id}</span> no existe
          </p>
          <p className="text-sm text-muted-foreground">
            Este manga podría haber sido eliminado o el ID podría ser incorrecto.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <Button asChild variant="outline" className="w-full">
            <Link href="/manga">Explorar mangas</Link>
          </Button>
        </div>
