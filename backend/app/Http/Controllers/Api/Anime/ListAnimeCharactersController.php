...
class ListAnimeCharactersController extends Controller
{
    #[OA\Get(
        path: '/api/v1/anime/{id}/characters',
        operationId: 'apiAnimeCharacters',
        summary: 'Lists characters for an anime',
        tags: ['Anime'],
        responses: [
    ...
    public function __invoke(MediaSectionService $sections, int $id): JsonResponse
    {
        ...
        return response()->json([
            'data' => $sections->charactersForAnime($id),
        ]);
    }
}
