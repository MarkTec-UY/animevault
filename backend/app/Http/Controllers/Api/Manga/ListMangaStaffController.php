...
class ListMangaStaffController extends Controller
{
    #[OA\Get(
        path: '/api/v1/manga/{id}/staff',
        operationId: 'apiMangaStaff',
        summary: 'Lists staff members for a manga',
        tags: ['Manga'],
        responses: [
    ...
    public function __invoke(MediaSectionService $sections, int $id): JsonResponse
    {
        ...
        return response()->json([
            'data' => $sections->staffForManga($id),
        ]);
    }
}
